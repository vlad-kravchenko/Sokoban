...
namespace Sokoban2Players
{
    public class AppleSolver
    {
        ...
        private bool InRange(Place place)
        {
            ...
            if (map[place.x, place.y] == Cell.None && (top[place.x, place.y] == Cell.None || top[place.x, place.y] == Cell.User1)) return true;
            if (map[place.x, place.y] == Cell.Here && (top[place.x, place.y] == Cell.None || top[place.x, place.y] == Cell.User1)) return true;
            return false;
        }
    }
}
